---
title: "Web Scraping, GIS data, Bag of Words, and Regression | Locating Long Polling Lines with Twitter Data"
author: "Asako Mikami"
...
**NB**: One core assumption that I carry throughout this report is that Pizza to the Polls did not send pizzas to polling locations in advance before receiving a third party report of a long line.
...
Finally, this project has motivated me to learn more data visualization techniques. I am not quite happy with many of the visualizations I produced in this project including the interactive map, which takes too much time to load. Even for the simpler plots, I would like to learn d3.js to incorporate [William Chase's visualiation tips](https://www.williamrchase.com/slides/assets/player/KeynoteDHTMLPlayer.html#0) such as using colored text in plot titles [instead of legends](https://twitter.com/djnavarro/status/1222952500237520897?s=20). I think I can do more cool visualizations using `ggfacet`.[^inspiration]

[^inspiration]: Inspiration taken from visualizations in [this](https://fivethirtyeight.com/features/more-women-are-holding-political-office-but-not-everywhere/) FiveThirtyEight article.
